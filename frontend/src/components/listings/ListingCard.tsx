  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <h3 className="mt-1 text-base font-semibold text-slate-900 dark:text-slate-50">{listing.title}</h3>
        ...
        <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-3 dark:border-slate-800">
          ...
          <PriceTag amountChf={Number(listing.price_chf)} className="text-lg font-semibold text-slate-900 dark:text-slate-50" />
        </div>
      </div>
    </Link>
  );
