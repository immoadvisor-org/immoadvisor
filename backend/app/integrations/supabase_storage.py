...
def _auth_headers() -> dict[str, str]:
    ...
    # Le API Supabase (Storage incluso) richiedono sia "apikey" sia
    # "Authorization": con le nuove chiavi sb_secret_* non bastano i soli
    # Bearer, altrimenti rispondono 400 "Invalid Compact JWS".
    return {
